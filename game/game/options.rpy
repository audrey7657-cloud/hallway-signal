...
define config.main_menu_music = "audio/main_menu_bgm.mp3"
...
define config.save_directory = "1-1776388342"
...
init python:
    ...
    config.mouse["inspect"] = [("gui/mouse_inspect.png", 8, 8)]
